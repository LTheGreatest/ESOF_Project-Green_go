...
class MockDataBaseUsers extends _i1.Mock implements _i6.DataBaseUsers {
  ...
  @override
  _i14.Future<dynamic> updateUsername(
    String? uid,
    String? username,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i14.Future<dynamic> updateUserFirstTime(
    String? uid,
    bool? firstTime,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i14.Future<dynamic> resetWeeklyPoints() => (super.noSuchMethod(
        Invocation.method(
          #resetWeeklyPoints,
          [],
        ),
  ...
  @override
  _i14.Future<dynamic> resetMonthlyPoints() => (super.noSuchMethod(
        Invocation.method(
          #resetMonthlyPoints,
          [],
        ),
